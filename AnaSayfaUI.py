...
"© 2021 GitHub, Inc.")
        ...
        self.groupBox.setGeometry(QtCore.QRect(30, 30, 601, 351))
        self.groupBox.setObjectName("groupBox")
        self.lwBrans = QtWidgets.QListWidget(self.groupBox)
        self.lwBrans.setGeometry(QtCore.QRect(70, 240, 211, 101))
        ...
        self.label_9.setGeometry(QtCore.QRect(300, 30, 71, 16))
        self.label_9.setObjectName("label_9")
        self.cwDTarihi = QtWidgets.QCalendarWidget(self.groupBox)
        self.cwDTarihi.setGeometry(QtCore.QRect(290, 50, 312, 183))
        self.cwDTarihi.setObjectName("cwDTarihi")
        self.label_8 = QtWidgets.QLabel(self.groupBox)
        self.label_8.setGeometry(QtCore.QRect(0, 240, 31, 16))
        self.label_8.setObjectName("label_8")
        self.widget = QtWidgets.QWidget(self.groupBox)
        self.widget.setGeometry(QtCore.QRect(0, 30, 279, 196))
        ...
        self.tblwSporcuBilgi.setGeometry(QtCore.QRect(30, 400, 851, 271))
        self.tblwSporcuBilgi.setRowCount(10)
        self.tblwSporcuBilgi.setColumnCount(100)
        self.tblwSporcuBilgi.setObjectName("tblwSporcuBilgi")
        self.widget1 = QtWidgets.QWidget(self.centralwidget)
        self.widget1.setGeometry(QtCore.QRect(660, 40, 221, 331))
        ...
        self.widget2.setGeometry(QtCore.QRect(30, 690, 170, 21))
        ...
        self.lblKayitSayisi = QtWidgets.QLabel(self.widget2)
        font = QtGui.QFont()
        font.setBold(True)
        font.setItalic(False)
        font.setWeight(75)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "Sporcu Soyadı:"))
        self.label_3.setText(_translate("MainWindow", "Spor Kulübü:"))
        ...
        self.label_6.setText(_translate("MainWindow", "Sporcu Kilosu:"))
        self.label_5.setText(_translate("MainWindow", "Sporcu Cinsiyeti:"))
